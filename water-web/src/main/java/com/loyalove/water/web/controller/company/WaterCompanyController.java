package com.loyalove.water.web.controller.company;

import com.loyalove.water.biz.company.WaterCompanyBiz;
...
public class WaterCompanyController extends BaseController {
    ...
    public Result queryWaterCompanys(WaterCompanyQuery query, Pager pager) {
        List<WaterCompanyVO> result = waterCompanyBiz.queryWaterCompanys(query, pager);
